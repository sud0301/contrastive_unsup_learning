...
def parse_option():
    ...
    # dataset
    parser.add_argument('--dataset', type=str, default='imagenet', choices=['imagenet100', 'imagenet', 'cifar10'])
...
def get_loader(args):
    ...
    #val_folder = os.path.join(args.data_root, 'val')
    #val_folder = '/misc/lmbraid19/mittal/my_repos/pytorch_repos/moco/data/imagenet/val/'
    val_folder = '/misc/lmbraid19/mittal/my_repos/cloned_repos/pytorch-classification/data/val'
